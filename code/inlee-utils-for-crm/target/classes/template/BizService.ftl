...
import com.jingcheng.marketing.business.mapper.${entity_name}Mapper;
    ...
    public MsgDto update${entity_name}(${entity_name} ${entity_name_low}) {
      ...
      List<${entity_name}> ${entity_name_low}List = ${entity_name_low}Mapper.selectListByMap(map);
        ...
        */
        ...
        return new MsgDto(Cons.SysCode.SUCCESS, "查询成功", true, ${entity_name_low}Mapper.selectById(id));
        }
        ...
        */
        public Page<Object> queryByPage(ParamsMap params) {
            return ${entity_name_low}Mapper.queryPage(params);
          }
